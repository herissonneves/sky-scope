...
export function createPageContainer(): HTMLDivElement {
  ...
  pageContainer.appendChild(cityLabel);
  pageContainer.appendChild(temperatureCard);
  pageContainer.appendChild(detailsCardsContainer);
  pageContainer.appendChild(resultElement);
